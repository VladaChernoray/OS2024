...
ResourceUsage bubble_sort(int arr[], int size) {
    ...
    usage.memory += sizeof(int); // for 'temp'
...
ResourceUsage quicksort(int arr[], int size) {
    ...
    int stackFrameSize = sizeof(int) * 3; 
...
void merge(int arr[], int leftPos, int rightPos, int rightEnd, ResourceUsage &usage) {
    ...
    int *temp = new int[numElements](); // Dynamically allocated temporary array
    usage.memory += numElements * sizeof(int); // Memory used by temp array
    int tempPos = 0;
...
ResourceUsage insert_sort(int arr[], int size) {
    ...
    usage.memory += sizeof(int); // for 'tmp'
...
int main() {
    ...
    cout << "Sorting average results written to sorting_average_results.txt" << endl;

    ofstream outputFile("tables/sorting_average_results.txt");
    ...
    cout << "Sorting results written to sorting_results.txt" << endl;

    ofstream outputFile_2("tables/sorting_results.txt", ios::out);
   ...
   for (int size : sizes) {
    ...
    string newDirectory = "data/integer";
